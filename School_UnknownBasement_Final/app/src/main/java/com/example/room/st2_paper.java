...
public class st2_paper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.st2_paper);
        ...
        st2_btn_hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(st2_paper.this, st2_paper_hint1.class);
        ...
        st2_btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(st2_paper.this, st2_MainActivity.class);
                startActivity(intent); //액티비티 이동
            }
        });
        ...
        st2_btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (st2_str.equals("4723") || st2_str.equals("4723 ") || st2_str.equals(" 4723") || st2_str.equals("4 7 2 3")) {
                    Toast.makeText(st2_paper.this, "정답입니다.", Toast.LENGTH_SHORT).show();
                    Toast.makeText(st2_paper.this, "특수종이를 획득하였습니다.", Toast.LENGTH_SHORT).show();
                    Toast.makeText(st2_paper.this, "힌트 버튼을 눌러 확인하세요.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(st2_paper.this, st2_MainActivity.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(st2_paper.this, "오답입니다.", Toast.LENGTH_SHORT).show();
                }
