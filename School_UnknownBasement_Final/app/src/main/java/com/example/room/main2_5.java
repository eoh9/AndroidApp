...
public class main2_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stage4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "더이상 갈 필요가 없어", Toast.LENGTH_SHORT).show(); //stage4 클릭시 이미 클리어한 스테이지임을 토스트
            }
        });
        stage5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main2_5.this, st5_StartAndEnding_HowToPlay.class);
